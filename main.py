...
def simulate_sequence(D, L, self_avoid, iterations):
...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description="Process in directory")
    ...
    parser.add_argument("--iterations", type=bool, nargs='?', default=500)

    args = parser.parse_args()

    data = simulate_sequence(args.D, args.L, args.self_avoid ,args.iterations)
